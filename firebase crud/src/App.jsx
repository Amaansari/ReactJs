          ...
          <div className="w-[400px]">
            <form className="space-y-6" onSubmit={edit ? saveEmployee : createEmployee}>
              <div className="flex flex-col">
                <label className="text-lg font-semibold mb-2">Employee Name</label>
                <input 
                  required
              ...
              <div className="flex flex-col">
                <label className="text-lg font-semibold mb-2">Joining Date</label>
                <input 
                  onChange={handleChange}
                  type="date"
                  required
                    ...
                    <tr key={index} className="border-b border-gray-300">
                      ...
                      <td>
                        <div className="space-x-2">
                          <button 
                            className="w-8 h-8 bg-indigo-600 text-white rounded-full" onClick={()=>editEmployee(item)}
                          >
                            <i className="ri-file-edit-line"></i>
                          </button>
                          <button 
                            className="w-8 h-8 bg-rose-600 text-white rounded-full" onClick={()=>deleteEmployee(item.uid)}
                          >
